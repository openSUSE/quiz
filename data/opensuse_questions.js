...
const questions = [
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "There is no default. We leave choice to the user.", correct: true }
    ]
  },
  {
  ...
  },
  {
    ...
    type: "mc",
    answers: [
      { text: "Use transactional-update command and reboot into a new snapshot", correct: true },
      { text: "By using sudo-sudo to gain giga privileges", correct: false },
      { text: "By using Salt or Ansible", correct: false },
      { text: "You have to edit files under a user netrunner and cross fingers", correct: false }
    ]
  },
  {
    text: "What is 'YaST'?",
    ...
    answers: [
      ...
      { text: "A free software for configuration of operating system", correct: false },
  ...
  },
  {
    ...
    type: "mc",
    answers: [
      { text: "A modern transactional-desktop system with GNOME", correct: true },
